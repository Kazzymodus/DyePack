    ...
    public class PartyBombProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.timeLeft <= 330)
            {
                ...
                float vibrationScalar = (1 - (projectile.timeLeft - 180) / 150f) * vibrationScalarMax;

                float vibrationX = Main.rand.NextFloat() * vibrationScalar;
                float direction = ((projectile.timeLeft % 2) - 0.5f) * 2;
